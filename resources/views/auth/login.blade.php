...
<!-- Mirrored from demo.foxthemes.net/socialite-v3.0/form-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 09:50:08 GMT -->
<head>
    <meta charset="UTF-8">
  ...
  <div class="sm:flex">
    ...
    <div class="relative lg:w-[580px] md:w-96 w-full p-10 min-h-screen bg-white shadow-xl flex items-center pt-10 dark:bg-slate-900 z-10">
      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
        ...
        <!-- form -->
        <form method="post" action="{{ route('loginUser') }}" class="space-y-7 text-sm text-black font-medium dark:text-white"  uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
          @csrf
          <!-- email -->
          <div>
...
<!-- Mirrored from demo.foxthemes.net/socialite-v3.0/form-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 09:50:09 GMT -->
</html>